...
- Approved spec path under `docs/ai/features/specs/`.
...
{
  "version": 1,
  "spec_path": "docs/ai/features/specs/feature-name.md",
  "base_commit": "<commit>",
  "agent": "codex",
  "epochs_completed": 1,
...
Write `docs/ai/features/summaries/{feature-slug}.md` inside the preserved GNHF worktree.
...
```html
<!-- orchestrator: outcome=continue provides=spec_path,summary_path,implementation_workspace_path,gnhf_budget_path spec_path=docs/ai/features/specs/{feature-slug}.md summary_path=docs/ai/features/summaries/{feature-slug}.md implementation_workspace_path=/absolute/path/to/worktree gnhf_budget_path=/absolute/path/to/budget.json -->
```
...
```html
<!-- orchestrator: outcome=stop-budget provides=spec_path,implementation_workspace_path,gnhf_notes_path,gnhf_log_path,gnhf_budget_path spec_path=docs/ai/features/specs/{feature-slug}.md implementation_workspace_path=/absolute/path/to/worktree gnhf_notes_path=/absolute/path/to/notes.md gnhf_log_path=/absolute/path/to/gnhf.log gnhf_budget_path=/absolute/path/to/budget.json -->
```
