---
name: extract-figma
description: Use when the user wants to extract a Figma frame into `docs/ai/features/designs/DD-MM-YYYY-figma-{name}.md` with exact specs, partial-progress support, and large-frame handling.
---
...
- the output path `docs/ai/features/designs/DD-MM-YYYY-figma-{name}.md`
...
- If `docs/ai/features/designs/figma-template.md` is missing, use the fallback structure and continue.
