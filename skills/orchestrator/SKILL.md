...
```json
{
  ...
  "artifact_paths": {
    ...
    "spec_path": "docs/ai/features/specs/my-feature.md",
    "summary_path": "docs/ai/features/summaries/my-feature.md",
    "checklist_path": "docs/ai/features/checklists/my-feature.md"
  },
  "step_inputs": {
    "execute-spec": {
      "spec_path": "docs/ai/features/specs/my-feature.md"
