...
Write to `docs/ai/features/checklists/{feature}.md` in Vietnamese.
...
- Store commands, assertions, screenshots, logs, detailed reasoning, and full evidence in `docs/ai/features/verifications/{feature}.md`, not in the checklist.
...
- The file is written to `docs/ai/features/checklists/{feature}.md`.
...
- Checklist written:
  `<!-- orchestrator: outcome=continue provides=checklist_path checklist_path=docs/ai/features/checklists/{feature}.md -->`
