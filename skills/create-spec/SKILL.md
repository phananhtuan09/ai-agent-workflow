...
10. Write `docs/ai/features/specs/{feature-name}.md`.
...
- Do not treat a precedent marked as intentional debt in `docs/ai/knowledge/architecture/decisions.md` as a pattern to mirror.
...
- Spec written:
  `<!-- orchestrator: outcome=continue provides=spec_path spec_path=docs/ai/features/specs/{feature-name}.md -->`
- Questions needed:
