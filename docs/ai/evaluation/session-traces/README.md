...
```text
docs/ai/evaluation/session-traces/{runtime}/{session-id}/
```

Examples:
- `docs/ai/evaluation/session-traces/claude/01bbffaa-86ff-46ae-b1ad-467fc7707fd4/`
- `docs/ai/evaluation/session-traces/codex/019f6165-e192-7df1-9ba2-1d04d476a678/`
