...
- docs/ai/research/: ideas, plans, and brainstorms
- docs/ai/features/: feature design, specification, and verification artifacts
...
- `docs/ai/features/verifications/`: implementation and runtime verification artifacts aligned to synced specs
