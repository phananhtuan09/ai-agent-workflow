...
```text
docs/evaluation/session-traces/{runtime}/{session-id}/session-trace.json
docs/evaluation/session-traces/{runtime}/{session-id}/chat-history.ndjson
docs/evaluation/session-traces/{runtime}/{session-id}/command-transcript.ndjson
docs/evaluation/session-traces/{runtime}/{session-id}/tool-call-trace.ndjson
docs/evaluation/session-traces/{runtime}/{session-id}/artifact-trail.ndjson
docs/evaluation/session-traces/{runtime}/{session-id}/handoff-notes.json
docs/evaluation/session-traces/{runtime}/{session-id}/decision-log.json
docs/evaluation/session-traces/{runtime}/{session-id}/failure-retry-log.json
```
...
Dung `docs/evaluation/templates/report.html`.
