...
const navigation = [{ href: "/", key: "nav.home" }];
...
export function SiteChrome({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-surface-low text-slate-100">
      <div className="hero-blur hero-blur-one" />
      <div className="hero-blur hero-blur-two" />
      <div className="hero-blur hero-blur-three" />

      <header className="border-white/6 sticky top-0 z-50 border-b bg-surface-base/80 backdrop-blur-xl">
      ...
      <footer className="border-white/6 border-t bg-surface-base/70">
