...
description: Use when the user provides a Figma URL, design file, frame, or mockup that should be turned into implementation-ready specifications. Extract exact values and structure instead of guessing.
---
