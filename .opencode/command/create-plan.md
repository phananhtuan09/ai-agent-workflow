...
- Read the requirement doc: `docs/ai/requirements/req-{name}.md`
...
4. **Multiple sources** → Ask user which to prioritize
...
Use @explore to search codebase for patterns related to the feature type:
...
**Load `figma-design-extraction` skill to:**
...
**Expected output:** "Design Specifications" section in planning doc.
...
**Load design skills to guide design decisions:**
...
Read `docs/ai/planning/feature-template.md` to understand required structure.
