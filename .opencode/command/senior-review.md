---
description: Senior developer code review focusing on clean code and maintainability.
agent: plan
---
...
2. **Base Branch** (if PR Style): main, develop, master, or custom
...
3. **Context handling:**
   ...
   - **Ticket/PRD:** Ask for content or link
...
Use @explore with very thorough search for Senior Developer code review.
