...
metadata:
  herdr-version: "0.9.1"
  upstream: "herdrdev/herdr@v0.9.1:skills/herdr/SKILL.md"
---
...
This global copy is synchronized with the official Herdr skill for Herdr `0.9.1`.
Compare the installed `herdr --version` with the `metadata.herdr-version` value above; when they differ, treat this skill as potentially outdated and re-sync it from the matching stable Herdr tag.
