...
4. **Multiple sources** → Request orchestrator to ask user which to prioritize:
...
**Q&A Format:** Present questions to orchestrator for user clarification with 2-4 options per question.
