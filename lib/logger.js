...
function printSummary(selectedTools) {
  const installedPaths = new Set(["docs/ai"]);
...
${colors.yellow}Next steps:${colors.reset}
  1. Review and customize ~/.codex/AGENTS.md for your project

  2. For Codex and Antigravity, keep shared skills in .agents/skills
  3. Check docs/ai/project/ for coding conventions

  4. Review any existing docs/ folder and confirm which docs should stay canonical
