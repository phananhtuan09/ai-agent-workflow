...
function syncDocsAI() {
  ...
  ["CODE_CONVENTIONS.md", "PROJECT_STRUCTURE.md", "README.md", "HARNESS_ARCHITECTURE.md"].forEach(
    (fileName) => {
...
function installWorkflowEvaluationKit(selectedTools) {
  const installedPaths = ["docs/ai/project/WORKFLOW_EVALUATION_STANDARD.md"];
  ...
  if (needsAgentsSkill) {
    ...
    syncFile(".agents/skills/workflow-evaluation/SKILL.md");
    installedPaths.push(".agents/skills/workflow-evaluation/SKILL.md");
  }

  if (needsClaudeSkill) {
    step("🔄 Syncing Claude workflow evaluation skill...");
    syncFile(".claude/skills/workflow-evaluation/SKILL.md");
    installedPaths.push(".claude/skills/workflow-evaluation/SKILL.md");
  }
