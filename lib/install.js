...
function syncDocsAI() {
  ...
  const legacySubfolders = ["planning", "testing", "requirements"];
  const filesToCopy = [
    "README.md",
    "unit-template.md",
    "req-template.md",
  ...
  legacySubfolders.forEach((subfolder) => {
...
function syncAgentsMd(stepMessage = "🔄 Syncing AGENTS.md to global scope (~/.codex/AGENTS.md)...") {
  ...
  try {
    ...
    const sourceAgentsMd = resolveSourcePath("AGENTS.md");

    if (!existsSync(sourceAgentsMd)) {
      throw new Error("Missing source file: AGENTS.md");
    }
...
function installCodingStandardKit(selectedTools) {
  ...
  return ["docs/ai", ...selectedTools.flatMap((tool) => tool.folders)];
}

function installWorkflowEvaluationKit(selectedTools) {
  const installedPaths = [
    ...
    "docs/ai/agent-observations/README.md",
    "docs/ai/workflow-observations/README.md",
    "docs/ai/workflow-evals/README.md",
    "docs/ai/workflow-evals/sample-workflow-evaluation.md",
    "docs/ai/session-traces/README.md",
  ];

  step("🔄 Syncing AI workflow rules...");
  syncFile("docs/ai/project/AI_WORKFLOW_RULES.md");
  ...
  ensureDir(resolveWorkspacePath("docs/ai/agent-observations"));
  ensureDir(resolveWorkspacePath("docs/ai/workflow-observations"));
  ensureDir(resolveWorkspacePath("docs/ai/workflow-evals"));
  ensureDir(resolveWorkspacePath("docs/ai/session-traces"));

  step("🔄 Syncing workflow evaluation artifacts docs...");
  syncFile("docs/ai/agent-observations/README.md");
  syncFile("docs/ai/workflow-observations/README.md");
  syncFile("docs/ai/workflow-evals/README.md");
  syncFile("docs/ai/workflow-evals/sample-workflow-evaluation.md");
  syncFile("docs/ai/session-traces/README.md");
  ...
  if (needsAgentsSkill) {
    ...
    syncFolder(".agents/skills/workflow-evaluation");
    syncFolder(".agents/skills/record-workflow-friction");
  ...
  if (needsClaudeSkill) {
    ...
    syncFolder(".claude/skills/workflow-evaluation");
    syncFolder(".claude/skills/record-workflow-friction");
