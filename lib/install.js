...
function syncSelectedSkills(runtime, skillIds) {
  ...
  skillIds.forEach((skillId) => {
    ...
    replaceDirectory(sourceDir, path.join(destinationRoot, skillId));
  });
}
...
function installWorkflowEvaluationKit(selectedTools, skillIds) {
  const installedPaths = [
    ...
    "docs/ai/evaluation/reports/sample-workflow-evaluation.md",
  ...
  syncFile("docs/ai/evaluation/reports/sample-workflow-evaluation.md");
